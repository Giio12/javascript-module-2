...
let restaurantFinderApplication = {
  ...
  let available=restaurants.map(restaurant => {
      let totalSeatsAvailable = restaurant.totalSeats - restaurant.numberOfCustomers
      if (totalSeatsAvailable >= numberOfPeople) {
